...
def densenet121(num_classes=1000, pretrained='imagenet', drop_rate=0.0):
    ...
    """
    model = models.densenet121(pretrained=False, drop_rate=0.0)
    if pretrained is not None:
...
def densenet169(num_classes=1000, pretrained='imagenet', drop_rate=0.0):
    r"""Densenet-169 model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`
    """
    model = models.densenet169(pretrained=False, drop_rate=0.0)
    if pretrained is not None:
